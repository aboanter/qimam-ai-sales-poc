...
assert.match(PRESENTATION_V4_CONTRACT,/under 1100 tokens/i);
assert.match(PRESENTATION_V4_CONTRACT,/at most 9 components/i);
assert.match(PRESENTATION_V4_CONTRACT,/Never copy factual values/i);
assert.match(PRESENTATION_V4_CONTRACT,/grounded facts/i);
